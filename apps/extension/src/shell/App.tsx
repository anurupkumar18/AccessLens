...
export function App({ client = defaultClient, pack, host = defaultHost, scheduler }: Props): React.ReactElement {
  ...
  const [studentView, setStudentView] = useState<View>('live');
    ...
    <ErrorBoundary>
      <main>
        ...
        {role === 'instructor' ? (
          ...
          <>
            <ViewTabs label="Student tools" view={studentView} onChange={setStudentView} />
            <div id="view-panel-live" role="tabpanel" aria-labelledby="view-tab-live" hidden={studentView !== 'live'}>
              <StudentExperience
                client={client}
                event={event}
                pack={studentPack}
            ...
            <div id="view-panel-materials" role="tabpanel" aria-labelledby="view-tab-materials" hidden={studentView !== 'materials'}>
              <StudentMaterials />
            </div>
          </>
        )}
