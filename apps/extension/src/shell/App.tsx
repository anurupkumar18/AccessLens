...
export function App({ client = defaultClient, pack, host = defaultHost, cameraHost = defaultCameraHost, scheduler, fetchPublishedPack: fetchPack = fetchPublishedPack, authoringClient, classroomClient }: Props): React.ReactElement {
