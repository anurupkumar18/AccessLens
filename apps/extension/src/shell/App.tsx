...
export function App({ client = defaultClient, pack, host = defaultHost, scheduler, fetchPublishedPack: fetchPack = fetchPublishedPack, authoringClient }: Props): React.ReactElement {
