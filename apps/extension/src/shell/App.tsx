...
export function App({ client = defaultClient, pack, host = defaultHost, scheduler, fetchPublishedPack: fetchPack = fetchPublishedPack, authoringClient, slides = defaultSlidesSource() }: Props): React.ReactElement {
      ...
      <main>
        ...
        {role === 'instructor' ? (
          <>
            ...
            {activePack && <InstructorPanel key={`${activePack.packId}@${activePack.version}`} client={client} pack={activePack} host={host} scheduler={scheduler} slides={slides} />}
