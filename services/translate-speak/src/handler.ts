...
const CORS = {
  // Same posture as the orb endpoint: the caller is a content script running on
  // whatever page the student is reading, so the origin is genuinely arbitrary.
  // This endpoint holds no user data and authorises nothing by origin.
